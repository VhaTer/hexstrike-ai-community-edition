...
TOOLS: Dict[str, dict] = {
    ...
    'masscan': {
        "desc": 'Fast mass port scanner for large subnets (useful on /24+ networks)',
    ...
    'rustscan': {
        "desc": 'Ultra-fast port scanner with Nmap integration for service detection',
    ...
    'smbmap': {
        "desc": 'SMB share enumeration with recursive listing and permission checks',
    ...
    'netexec': {
        ...
        "category": 'network_recon',
        "params": {'target': {'required': True}},
        "optional": {'protocol': 'smb', 'username': '', 'password': '', 'hash': '', 'module': '', 'additional_args': ''},
        "effectiveness": 0.88,
    },
    'gobuster': {
    ...
    'feroxbuster': {
        "desc": 'Recursive content discovery with intelligent filtering and wildcard detection',
    ...
    'dirsearch': {
        "desc": 'Web path and directory scanner with recursive brute-force',
    ...
    'joomscan': {
        "desc": 'Joomla CMS vulnerability scanner with component and plugin detection',
    ...
    'testssl': {
        ...
        "category": 'web_recon',
        "params": {'target': {'required': True}},
        "optional": {'protocols': True, 'server_defaults': True, 'server_preference': False, 'forward_secrecy': False, 'headers': False, 'vulnerable': False, 'full': False, 'client_simulation': False, 'rating_only': False, 'starttls': '', 'severity': '', 'json_output': False, 'jsonfile': '/tmp/testssl_output.json', 'quiet': True, 'proxy': '', 'ipv4_only': False, 'ipv6_only': False, 'ip': '', 'additional_args': ''},
        "effectiveness": 0.88,
    },
    'nuclei': {
    ...
    'dalfox': {
        "desc": 'XSS vulnerability scanner with DOM analysis and blind XSS support',
    ...
    'xsser': {
        "desc": 'Cross-site scripting scanner with multiple injection vectors and bypass techniques',
    ...
    'dotdotpwn': {
        "desc": 'Directory traversal and path injection vulnerability scanner',
    ...
    'zap': {
        ...
        "category": 'web_recon',
        "params": {},
        "optional": {'target': '', 'scan_type': 'baseline', 'api_key': '', 'daemon': False, 'port': 8090, 'host': '0.0.0.0', 'format': 'xml', 'output_file': '', 'additional_args': ''},
        "effectiveness": 0.86,
    },
    'commix': {
    ...
    'msfvenom': {
        "desc": 'Metasploit payload generator with encoding and output format options',
    ...
    'hydra': {
        "desc": 'Network login brute-forcer supporting 50+ protocols (ssh, ftp, http, smb, rdp)',
    ...
    'medusa': {
        "desc": 'Network login brute-forcer with parallel connection testing',
    ...
    'patator': {
        "desc": 'Multi-purpose brute-forcer with modular protocol support',
    ...
    'bloodhound': {
        ...
        "method": 'POST',
        "category": 'active_directory',
        "params": {'domain': {'required': True}, 'username': {'required': True}, 'password': {'required': True}, 'dc_ip': {'required': True}},
        "optional": {'additional_args': ''},
        "effectiveness": 0.9,
    },
    'bloodhound_python': {
    ...
    'impacket': {
        ...
        "method": 'POST',
        "category": 'active_directory',
        "params": {'script': {'required': True}, 'target': {'required': True}},
    ...
    'impacket-ad-enum': {
        ...
        "category": 'active_directory',
        "params": {'script': {'required': True}, 'target': {'required': True}},
        "optional": {'dc_ip': '', 'username': '', 'password': '', 'hashes': '', 'kerberos': False, 'no_pass': False, 'aes_key': '', 'debug': False, 'extra_options': '', 'extra_args': ''},
        "effectiveness": 0.92,
    },
    'impacket-remote-exec': {
        ...
        "params": {'script': {'required': True}, 'target': {'required': True}},
        "optional": {'command': '', 'username': '', 'password': '', 'domain': '', 'hashes': '', 'kerberos': False, 'no_pass': False, 'aes_key': '', 'share': '', 'shell_type': '', 'debug': False, 'extra_options': '', 'extra_args': '', 'use_recovery': True},
        "effectiveness": 0.91,
    },
    'parsero': {
    ...
    'subfinder': {
        "desc": 'Passive subdomain discovery using multiple OSINT sources',
    ...
    'fierce': {
        "desc": 'DNS reconnaissance with zone transfer testing and reverse lookup',
    ...
    'airmon-ng': {
        ...
        "method": 'POST',
        "category": 'wifi_pentest',
        "params": {'interface': {'required': True}, 'action': {'required': True}},
        "optional": {'channel': ''},
        "effectiveness": 0.95,
    },
    'airodump-ng': {
        ...
        "category": 'wifi_pentest',
        "params": {'interface': {'required': True}},
        "optional": {'output_prefix': 'capture', 'bssid': '', 'channel': '', 'essid': ''},
        "effectiveness": 0.93,
    },
    'aireplay-ng': {
        ...
        "method": 'POST',
        "category": 'wifi_pentest',
        "params": {'interface': {'required': True}, 'attack_mode': {'required': True, 'type': 'int'}},
        "optional": {'bssid': '', 'client_mac': '', 'count': 0},
        "effectiveness": 0.9,
    },
    'checksec': {
    ...
    'ropgadget': {
        "desc": 'Find ROP/JOP gadgets in binaries for exploit development',
    ...
    'prowler': {
        "desc": 'Multi-cloud security audit (AWS, Azure, GCP) with CIS benchmark checks',
