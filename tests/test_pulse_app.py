...
# Documented contract: every key in pulse_dashboard()'s state={} must be
# traceable to a source in _collect_dashboard_state() or a documented derived
# field. Any divergence between this mapping and the real state fails the
# parity test below — this is the guard rail against silent key drift.
