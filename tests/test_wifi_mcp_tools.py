...
Strategy:
- Mock hexstrike_client to intercept safe_post() calls
...
def make_mock_client(success=True, extra=None):
    client = MagicMock()
    response = {"success": success, "output": "mocked", "returncode": 0}
    if extra:
        response.update(extra)
    client.safe_post = MagicMock(return_value=response)
    return client


def make_mcp_with(register_fn, client=None, logger=None):
    mcp = FastMCP("test-hexstrike")
    if client is None:
        client = make_mock_client()
    if logger is None:
        logger = MagicMock()
    register_fn(mcp, client, logger)
    return mcp, client, logger
...
class TestAirmonNg:
    ...
    def setup(self):
        ...
        self.mcp, self.client, self.logger = make_mcp_with(register_airmon_ng_tools, self.client)

    def test_tool_registered(self):
        run(assert_tool_registered(self.mcp, "airmon_ng"))

    def test_check_kill_calls_correct_endpoint(self):
        run(call_tool(self.mcp, "airmon_ng", interface="wlan0", action="check kill"))
        endpoint, data = self.client.safe_post.call_args[0]
        assert endpoint == "api/tools/wifi_pentest/airmon_ng"
    ...
    def test_start_monitor_mode(self):
        ...
        _, data = self.client.safe_post.call_args[0]
    ...
    def test_returns_failure_result(self):
        self.client.safe_post.return_value = {"success": False, "error": "permission denied"}
        result = run(call_tool(self.mcp, "airmon_ng", interface="wlan0", action="start"))
...
class TestAirodumpNg:
    ...
    def setup(self):
        ...
        self.client = make_mock_client()
        self.mcp, self.client, self.logger = make_mcp_with(register_airodump_ng_tools, self.client)
    ...
    def test_calls_correct_endpoint(self):
        ...
        endpoint, data = self.client.safe_post.call_args[0]
        assert endpoint == "api/tools/wifi_pentest/airodump_ng"
        assert data["interface"] == "wlan0mon"
...
class TestAireplayNg:
    ...
    def setup(self):
        ...
        self.client = make_mock_client()
        self.mcp, self.client, self.logger = make_mcp_with(register_aireplay_ng_tools, self.client)

    def test_tool_registered(self):
        run(assert_tool_registered(self.mcp, "aireplay_ng"))

    def test_deauth_calls_correct_endpoint(self):
        run(call_tool(self.mcp, "aireplay_ng",
            interface="wlan0mon", attack_mode="deauth",
            bssid="AA:BB:CC:DD:EE:FF", count="10"))
        endpoint, data = self.client.safe_post.call_args[0]
        assert endpoint == "api/tools/wifi_pentest/aireplay_ng"
...
# ===========================================================================
# aircrack_ng — capture_files is a List[str], not a single file
# ===========================================================================
...
class TestAircrackNg:
    ...
    def setup(self):
        ...
        self.client = make_mock_client()
        self.mcp, self.client, self.logger = make_mcp_with(register_aircrack_ng_tools, self.client)
    ...
    def test_calls_correct_endpoint(self):
        ...
        endpoint, data = self.client.safe_post.call_args[0]
        assert endpoint == "api/tools/wifi_pentest/aircrack_ng"
...
class TestHcxdumptool:
    ...
    def setup(self):
        ...
        self.client = make_mock_client()
        self.mcp, self.client, self.logger = make_mcp_with(register_hcxdumptool_tools, self.client)
    ...
    def test_calls_correct_endpoint(self):
        ...
        endpoint, data = self.client.safe_post.call_args[0]
        assert endpoint == "api/tools/wifi_pentest/hcxdumptool"
        assert data["interface"] == "wlan0mon"
...
class TestHcxpcapngtool:
    ...
    def setup(self):
        ...
        self.client = make_mock_client()
        self.mcp, self.client, self.logger = make_mcp_with(register_hcxpcapngtool_tools, self.client)
    ...
    def test_calls_correct_endpoint(self):
        ...
        endpoint, data = self.client.safe_post.call_args[0]
        assert endpoint == "api/tools/wifi_pentest/hcxpcapngtool"
...
class TestWifite2:
    ...
    def setup(self):
        ...
        self.client = make_mock_client()
        self.mcp, self.client, self.logger = make_mcp_with(register_wifite2_tools, self.client)
    ...
    def test_calls_correct_endpoint(self):
        ...
        endpoint, data = self.client.safe_post.call_args[0]
        assert endpoint == "api/tools/wifi_pentest/wifite2"
        assert data["interface"] == "wlan0mon"


# ===========================================================================
# eaphammer — param is essid, not ssid
# ===========================================================================
...
class TestEaphammer:
    ...
    def setup(self):
        ...
        self.client = make_mock_client()
        self.mcp, self.client, self.logger = make_mcp_with(register_eaphammer_tools, self.client)
    ...
    def test_calls_correct_endpoint(self):
        ...
        endpoint, data = self.client.safe_post.call_args[0]
        assert endpoint == "api/tools/wifi_pentest/eaphammer"
...
class TestBettercapWifi:
    ...
    def setup(self):
        ...
        self.client = make_mock_client()
        self.mcp, self.client, self.logger = make_mcp_with(register_bettercap_wifi_tools, self.client)
    ...
    def test_calls_correct_endpoint(self):
        ...
        endpoint, data = self.client.safe_post.call_args[0]
        assert endpoint == "api/tools/wifi_pentest/bettercap_wifi"
        assert data["interface"] == "wlan0mon"
...
class TestMdk4:
    ...
    def setup(self):
        ...
        self.client = make_mock_client()
        self.mcp, self.client, self.logger = make_mcp_with(register_mdk4_tools, self.client)
    ...
    def test_calls_correct_endpoint(self):
        ...
        endpoint, data = self.client.safe_post.call_args[0]
        assert endpoint == "api/tools/wifi_pentest/mdk4"
        assert data["attack_mode"] == "b"


# ===========================================================================
# airbase_ng — param is essid, not ssid
# ===========================================================================
...
class TestAirbaseNg:
    ...
    def setup(self):
        ...
        self.client = make_mock_client()
        self.mcp, self.client, self.logger = make_mcp_with(register_airbase_ng_tools, self.client)
    ...
    def test_calls_correct_endpoint(self):
        ...
        endpoint, data = self.client.safe_post.call_args[0]
        assert endpoint == "api/tools/wifi_pentest/airbase_ng"
...
# ===========================================================================
# airdecap_ng — param is password, not passphrase
# ===========================================================================
...
class TestAirdecapNg:
    ...
    def setup(self):
        ...
        self.client = make_mock_client()
        self.mcp, self.client, self.logger = make_mcp_with(register_airdecap_ng_tools, self.client)
    ...
    def test_calls_correct_endpoint(self):
        ...
        endpoint, data = self.client.safe_post.call_args[0]
        assert endpoint == "api/tools/wifi_pentest/airdecap_ng"
