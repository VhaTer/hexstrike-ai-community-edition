...
from pulse.infrastructure.singletons import cache, telemetry, enhanced_process_manager, error_handler, get_tool_stats_store
...
def _build_dashboard_response():
    ...
    try:
        from pulse.interface.pulse_app import _collect_dashboard_state, get_tool_intelligence
...
def register_http_routes(mcp, logger, static_dir=None):
    ...
    async def stream_logs(request):
        ...
        """
        from pulse.infrastructure.setup_logging import get_log_buffer
...
if __name__ == "__main__":
    ...
    from pulse.infrastructure.modern_visual_engine import ModernVisualEngine as _MVE
