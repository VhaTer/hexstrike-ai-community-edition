...
import fcntl
import atexit
from pulse.interface.server_setup import setup_mcp_server_standalone, _scan_cache
...
def _prewarm_singletons(logger):
    ...
    def _warm():
        ...
        try:
            from pulse.infrastructure.singletons import get_decision_engine, get_tool_stats_store
