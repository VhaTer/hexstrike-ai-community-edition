...
async def run_security_tool(
    ...
    if result.get("success"):
        ...
        if error_msg:
            from pulse.infrastructure.singletons import error_handler as _eh
...
def setup_mcp_server_standalone(logger=None) -> FastMCP:
    ...
    from pulse.interface.instructions import INSTRUCTIONS
    mcp = FastMCP(
        "hexstrike-ai pulse",
    ...
    # ========================================================================
    from pulse.intelligence.intelligent_decision_engine import IntelligentDecisionEngine as _IDE
    _ide = _IDE()
    ...
    from pulse.interface.prompts import register_prompts
