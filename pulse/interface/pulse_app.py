...
def rev_entropy_map(file_path: str, block_size: int = 256, threshold: float = 7.0) -> dict:
    ...
    """
    from pulse.tools.rev_direct import compute_entropy_map
...
def crypto_xor_crack(
    ...
    """
    from pulse.tools.crypto_direct import xor_crack
    return xor_crack(
        data=data,
        file_path=file_path,
...
def crypto_z3_solve(
    ...
    """
    from pulse.tools.crypto_direct import z3_solve
    return z3_solve(
...
def crypto_rsa_attack(
    ...
    """
    from pulse.tools.crypto_direct import rsa_attack
    return rsa_attack(
...
def binary_varint(
    ...
    """
    from pulse.tools.binary_direct import binary_varint as _fn
...
def binary_block_parser(
    ...
    from pulse.tools.binary_direct import binary_block_parser as _fn
...
def binary_rle_decode(
    ...
    """
    from pulse.tools.binary_direct import binary_rle_decode as _fn
...
def binary_signal_decode(
    ...
    from pulse.tools.binary_direct import binary_signal_decode as _fn
    return _fn(
        data_hex=data_hex,
