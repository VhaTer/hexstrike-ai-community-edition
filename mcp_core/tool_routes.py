...
TOOL_ROUTES = {
    ...
    "gdb-peda":          ("mcp_core.misc_direct", "misc_exec", "gdb-peda"),
    "radare2":           ("mcp_core.misc_direct", "misc_exec", "radare2"),
    "strace":            ("mcp_core.misc_direct", "misc_exec", "strace"),
    "ltrace":            ("mcp_core.misc_direct", "misc_exec", "ltrace"),
    ...
    "browser_eval":      ("mcp_core.browser_direct", "browser_exec", "browser_eval"),
    # web_probe
